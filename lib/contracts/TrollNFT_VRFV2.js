...
class TrollNFT_VRFV2 extends eth_contract_1.Contract {
    ...
    decodeAddStakesEvent(event) {
        ...
        return {
            ...
            amountAdded: new eth_contract_1.BigNumber(result.amountAdded),
    ...
    decodeEquipNFTEvent(event) {
        let result = event.data;
        return {
            trollId: new eth_contract_1.BigNumber(result.trollId),
            nft: result.nft,
            nftId: new eth_contract_1.BigNumber(result.nftId),
            _event: event
        };
    }
    ...
    decodeStakesApprovalEvent(event) {
        let result = event.data;
        return {
            fromTokenId: new eth_contract_1.BigNumber(result.fromTokenId),
    ...
    decodeStakesTransferEvent(event) {
        ...
        return {
            fromTokenId: new eth_contract_1.BigNumber(result.fromTokenId),
            toTokenId: new eth_contract_1.BigNumber(result.toTokenId),
            amount: new eth_contract_1.BigNumber(result.amount),
            _event: event
        };
    }
